...
$user_data['systemName'] = getenv('GIBBON_SYSTEM_NAME');
$user_data['installType'] = getenv('GIBBON_INSTALL_TYPE') || "Production";
$user_data['timezone'] = getenv('GIBBON_TIMEZONE');
$user_data['country'] = getenv('GIBBON_COUNTRY');
$user_data['currency'] = getenv('GIBBON_CURRENCY');
$user_data['statsCollection'] = "N";
$user_data['cuttingEdgeCode'] = "No";
$user_data['support'] = "";
$user_data['organisationName'] = getenv('GIBBON_ORGANISATION_NAME');
$user_data['organisationNameShort'] = getenv('GIBBON_ORGANISATION_INITIALS');
